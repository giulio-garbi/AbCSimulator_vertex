...
//		// Configure XYGraph
		...
		int samples = 100;
		int replications = 10;
		SingleServerFactory factory = new SingleServerFactory(512,1, (x,y) -> 15.0 , x -> 1000.0 , x -> 0.03 );
...
//		StatisticSampling<AbCSystem> sentMessages = new StatisticSampling<>(2001, 0.5, new TravellingMessages());
		SamplingCollection<AbCSystem> collection = new SamplingCollection<>( averageDeliveryTime, maxDeliveryTime, minDeliveryTime, numberOfDeliveredMessages,averageWaitingSize, averageTimeInterval,minTimeInterval,maxTimeInterval);
